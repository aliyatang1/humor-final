...
- Name: gallery.spec.ts >> Brand & Visual Elements >> logout page should display HUMOR FEED branding
- Location: tests/gallery.spec.ts:65:7
...
Locator: getByText(/Signing out/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Signing out/i)
